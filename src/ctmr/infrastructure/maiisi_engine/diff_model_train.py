...
# copy of ``scripts/diff_model_train.py`` with import lines rewritten to this package home.
...
def train_one_epoch(
    ...
    """
    # Unwrap DDP for custom-attribute reads (DDP does not forward module attributes).
