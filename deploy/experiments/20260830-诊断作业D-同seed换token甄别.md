...
- METS cohort 3 例份额 0.6060/0.6187/0.6148——与总体一致(n=3,证据地位:**无反证**,非阴性对照)
...
3. **ET 缺失不能由 token 稀释单独解释**:作业 B 的 ET 缺失全部集中 METS(10/48),而 D 的 METS cohort 份额无特异恶化(n=3,无反证),且 16 例 cohort 五臂全部产出亮核(D 测亮核幅度,不测 ET 检出)——METS 缺失的机理指向空间/尺寸保真侧,与作业 A/复核的质心放置低精度、WT 体积系统性过估同向。
...
- [x] 读数交收编票(#210)与作业 A/复核 A/B/C 合流,裁决表与整改决议已落盘,序列②已开票 #247
- [x] 服务器重组后的新路径布局(P1_ROOT/DEV_LIST/EMB_ROOT/部署树)已在本记录登记,后续作业配方沿用;旧路径首轮遗留 log/pid 经 2026-08-30 SSH 核实:旧路径 `/root/private_data/brats2023_rflow_p1/token_dilution/` 已随资产重组消失,清理事项关闭
