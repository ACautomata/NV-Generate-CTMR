...
# (#271, 5 edges), modality-label (#272, 9), mask (#273, 9) and cross-modal
# (#274, 16) families.  When the ratchet reaches zero the list is deleted
# and the gate turns purely terminal-state (issue #10).
