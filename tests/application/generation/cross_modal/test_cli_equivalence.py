...
FINETUNE_ARGV = [
    ...
    "-c",
    "configs/config_brats_p3_train.json",
    "-t",
    "configs/config_network_p3.json",
    "-g",
    "7",
    "--data-list",
    "runs/p3/x/p3_pairs.json",
]
...
BASELINE_ARGV = [
    "--run",
    "runs/p3-stage0/run.json",
    "--manifest",
    "/ctrl/phase/phase_manifest.json",
    "--out-root",
    "/ctrl/p3/stage0_holdout",
    "--raw-root",
    "/ctrl/phase/raw",
    "-e",
    "env.json",
...
CANDIDATE_ARGV = [
    "--run",
    "runs/p3-candidate/run.json",
    "--manifest",
    "/ctrl/phase/phase_manifest.json",
    "--out-root",
    "/ctrl/p3/candidate_holdout",
    "--raw-root",
    "/ctrl/phase/raw",
    "--stage0-pairs",
    "/ctrl/p3/stage0_holdout/pairs.json",
    "-e",
    "env.json",
    "-c",
    "config.json",
    ...
    "net.json",
    "--infer-config",
    "config_p3_controlnet_infer.json",
    "--side",
    "holdout",
    "--shard",
    "0",
...
def _reference_dev_eval_parser():
    ...
    ``--device`` injection flag on the device-consuming watch verb (issue
    #280, ADR-0019 §8; the reference verb is pure-CPU resampling, no device),
    and the watch verb's offline rework -- ``--poll-seconds``/
