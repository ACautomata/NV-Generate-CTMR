...
from ctmr.application.generation.trends import DevCohortBuilder
...
def test_condition_remap_table_matches_the_terminal_acceptance_table():
    from scripts.nnunet_l2_final_acceptance_nifti import COMBINED_TO_INSTRUMENT as ACCEPTANCE_TABLE
